...
export function AnnotationOverlay({
	...
	const renderArrow = () => {
		...
		const color = annotation.figureData?.color || "#7C5CFF";
					...
					<div className="w-full h-full relative">
						...
						>
							...
							{isSelected && shape !== "freehand" && (
								<div
									className="absolute inset-0 pointer-events-none border-2 border-[#7C5CFF]/80"
	...
	return (
		<Rnd
			...
			style={{
				...
				border:
					isSelected && annotation.type !== "blur" ? "2px solid rgba(124, 92, 255, 0.8)" : "none",
				backgroundColor:
					isSelected && annotation.type !== "blur" ? "rgba(124, 92, 255, 0.1)" : "transparent",
				boxShadow:
					isSelected && annotation.type !== "blur" ? "0 0 0 1px rgba(124, 92, 255, 0.35)" : "none",
			}}
			...
			resizeHandleStyles={{
				topLeft: {
					...
					border: isSelected ? "2px solid #7C5CFF" : "none",
					borderRadius: "50%",
					left: "-6px",
					top: "-6px",
					cursor: "nwse-resize",
