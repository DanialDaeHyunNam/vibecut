				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#7C5CFF]/50 focus:ring-offset-2 focus:ring-offset-[#09090b]",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#7C5CFF]/20 text-[#7C5CFF]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#7C5CFF]" />
						)}
					</button>
				);
			})}
