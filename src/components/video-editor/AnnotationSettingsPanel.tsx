			...
			<div className="mb-3">
				...
				>
					<TabsList className="mb-4 bg-white/[0.035] border border-white/[0.06] p-0.5 w-full grid grid-cols-3 h-9 rounded-xl">
						<TabsTrigger
							value="text"
							className="data-[state=active]:bg-[#7C5CFF] data-[state=active]:text-white text-slate-400 rounded-lg transition-all gap-1.5 text-[11px]"
						>
					...
					<TabsContent value="text" className="mt-0 space-y-4">
						<div>
							...
							<textarea
								...
								rows={5}
								className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-slate-200 text-sm placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#7C5CFF] focus:border-transparent resize-none"
							/>
						</div>
					...
					<TabsContent value="image" className="mt-0 space-y-4">
						...
						<Button
							...
							variant="outline"
							className="w-full gap-2 bg-white/5 text-slate-200 border-white/10 hover:bg-[#7C5CFF] hover:text-white hover:border-[#7C5CFF] transition-all py-8"
						>
						...
						<div>
							...
							<Popover>
								<PopoverTrigger asChild>
									...
									>
										<div
											...
											style={{ backgroundColor: annotation.figureData?.color || "#7C5CFF" }}
										/>
										<span className="text-xs text-slate-300 truncate flex-1 text-left">
											{annotation.figureData?.color || "#7C5CFF"}
										</span>
										<ChevronDown className="h-3 w-3 opacity-50" />
									</Button>
								</PopoverTrigger>
								<PopoverContent className="w-[260px] p-3 bg-[#1a1a1c] border border-white/10 rounded-xl shadow-xl">
									<Block
										color={annotation.figureData?.color || "#7C5CFF"}
										colors={colorPalette}
										onChange={(color) => {
											const newFigureData: FigureData = {
												...annotation.figureData!,
